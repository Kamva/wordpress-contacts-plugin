		...
		function generate_main_page() {
			...
			?>
				...
				if ( 'create' === $sort ) {
					...
					?>
					<iframe id="datamain"
							src="https://email.kamva.ir/camp/step1/type/<?php echo esc_attr( $type ); ?>/access_token/<?php echo esc_attr( $access_token ); ?>/lang/<?php echo esc_attr( $lang ); ?>"
							width="100%" height="750" scrolling="yes"></iframe>
					<?php
				} else {
					?>
					<iframe id="datamain"
						src="https://email.kamva.ir/camp/listing/access_token/<?php echo esc_attr( $access_token ); ?>/lang/<?php echo esc_attr( $lang ); ?>#<?php echo esc_attr( $sort ); ?>"
						width="100%" height="750" scrolling="yes"></iframe>
