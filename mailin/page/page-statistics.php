...
if ( ! class_exists( 'SIB_Page_Statistics' ) ) {
	...
	class SIB_Page_Statistics {
		...
		function generate_main_page() {
			...
			?>
				<iframe id="datamain" src="https://email.kamva.ir/camp/message/access_token/<?php echo esc_attr( $access_token ); ?>/lang/<?php echo esc_attr( $lang ); ?>" width="100%" height="750" scrolling="yes"></iframe>
		<?php
		}
